...
namespace MTConnectSharp
{
    internal static class ParseUtility
    {
        ...
        public static string GetAttribute(this XElement xElem, string Attribute)
        {
            return xElem.Attribute(Attribute)?.Value ?? string.Empty;
        }
        ...
        public static List<DataItem> GetDataItems(this XElement xElem)
        {
        ...
        public static List<Component> GetComponents(this XElement xElem)
        {
            return xElem.Elements()
